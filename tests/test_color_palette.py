...
class TestColorPalette(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_arw = 'tests/assets/DSC00504.ARW'
        self.test_jpg = 'tests/assets/DSC00504.JPG'
    ...
    def test_palette_raw_file(self):
        ...
        palette = generate_color_palette(self.test_arw, 5)
    ...
    def test_palette_jpg_file(self):
        ...
        palette = generate_color_palette(self.test_jpg, 7)
    ...
    def test_palette_nonexistent_file(self):
        ...
        palette = generate_color_palette('/path/to/nonexistent/file.arw', 5)
    ...
    def test_palette_custom_count(self):
        ...
        palette_3 = generate_color_palette(self.test_arw, 3)
        palette_10 = generate_color_palette(self.test_arw, 10)
