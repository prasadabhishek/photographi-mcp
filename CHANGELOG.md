...
### Changed
- **MCP Registry**: Re-release with validation token properly included in PyPI package.

## [0.2.5] - 2026-02-15

### Changed
- **MCP Registry**: Added ownership validation token to README for official MCP Registry submission.
